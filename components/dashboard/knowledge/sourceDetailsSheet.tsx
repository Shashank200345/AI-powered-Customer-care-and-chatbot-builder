...
import { getTypeIcon, getStatusBadge } from './knowledgeTable';
                ...
                <div className='h-full flex flex-col'>
                    ...
                    <div className='flex-1 overflow-y-auto p-6 space-y-6'>
                        <div className='space-y-4'>
                            ...
                            <div className='p-4 rounded-lg border border-white/5 bg-black/40 font-mono text-zinc-400 h-72 overflow-y-auto leading-relaxed'>
                                {selectedSource.content || `# ${selectedSource.name}\n\n(No content available)`}
                            </div>
                        </div>
                    </div>
                    <SheetFooter className='p-6 border-t border-white/5 bg-[#050509]'>
                        <Button variant='destructive' className='w-full bg-red-500/10 text-red-500 hover:bg-red-500/20 sm:w-auto'>
                            Delete Source
                        </Button>
                    </SheetFooter>
                </div>
