...
const Integration = () => {
  return (
    ...
    <section id='how-it-works' className='py-24 border-t border-white/5 bg-black/20'>
        <div className='max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16'>
            <div className='flex-1'>
                <h2 className='text-3xl md:text-4xl font-medium text-white tarcking-tight mb-6'>
                    Drop-in simplicity.
                </h2>
                <p className='text-lg text-zinc-400 font-light mb-8 leading-relaxed'>
                    ...
                    you&apos;re good to go. We inherit your CSS variables automatically.
                </p>
                ...
                <div className='glass-card rounded-xl p-6 relative'>
                    ...
                    <div className='font-mono text-xs md:text-sm leading-7 text-zinc-400'>
                        ...
                        <div className='pl-4'>
                            ...
                            <span className='text-emerald-400'>&quot;b7885803-18ca-479b-baf6-c6b289e309a5&quot;</span>
                            <br />
