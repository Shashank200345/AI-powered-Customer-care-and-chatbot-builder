    ...
    <section id="features" className='py-32 px-6 max-w-6xl mx-auto'>
        <div className='mb-20'>
            ...
            <p className='text-xl text-zinc-500 font-light max-w-xl leading-relaxed'>
                Most AI support tools hallucinate. Ours is strictly gorunded in your 
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='group p-8 rounded-3xl border border-white/5 bg-linear-to-b from-white/3 to-transparent hover:border-white/10 transition-colors'>
                <div className='w-12 h-12 rounded-2xl bg-[#0A0A0E] border border-white/10 flex items-center justify-center mb-6 group-hover:scale-105 transition-tarnsform'>
                ...
                <p className='text-sm text-zinc-400 font-light leading-relaxed'>
                    We crawl your site and docs to build a structured undersatanding of your product.
            ...
            <div className='group p-8 rounded-3xl border border-white/5 bg-linear-to-b from-white/3 to-transparent hover:border-white/10 transition-colors'>
                ...
                <p className='text-sm text-zinc-400 font-light leading-relaxed'>
                    Define exaclty what the AI can and cannot say. It will politely
            ...
            <div className='group p-8 rounded-3xl border border-white/5 bg-linear-to-b from-white/3 to-transparent hover:border-white/10 transition-colors'>
                ...
                <p className='text-sm text-zinc-400 font-light leading-relaxed'>
                    Weather you&apos;re professional, quirky, or concise, the AI mimics
