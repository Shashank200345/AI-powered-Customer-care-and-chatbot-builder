    ...
    <section id='pricing' className='py-32 px-6 max-w-6xl mx-auto text-center'> 
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto'>
            ...
            <div className='relative overflow-hidden p-8 rounded-3xl border border-white/10 bg-white/3 flex flex-col items-start text-left hover:bg-zinc-900/40 transition-colors'>
                <div className='absolute top-0 right-0 px-4 py-1 bg-white/10 rounded-bl-xl text-[10px]'>Popular</div>
                ...
                <button className='w-full cursor-pointer bg-white text-black py-3 rounded-xl border border-white/10 hover:bg-zinc-200 transition-colors text-sm font-medium mt-auto'>
                    Get Started
                </button>
            </div>
        </div>
