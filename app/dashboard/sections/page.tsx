  ...
  return (
    <div className='p-8 space-y-6'>
        <div className='flex items-center justify-between'>
            ...
            <Button className='bg-white text-black hover:bg-zinc-200' onClick={handleCreateSection}>
                    ...
                    <>
                      ...
                      {selectedSection.id == "new" && (
                        <div className='p-6 border-t border-white/5'>
                            <Button className='w-full bg-white text-black hover:bg-zinc-300' onClick={handleSaveSection} disabled={isSaving}>
                      ...
                      <div className='p-6 bg-red-500/5 border-t border-red-500/10'>
                        ...
                        <Button variant='destructive' className='w-full bg-red-500/10 text-red-500 border border-red-500/20 hover:bg-red-500/20 shadow-none' onClick={handleDeleteSection} disabled={isSaving}>{isSaving ? "Deleting..." : "Delete Section"}</Button>
                      </div>
                      )}
                    </>
                )}
